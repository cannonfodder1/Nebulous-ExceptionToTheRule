...
namespace ExceptionToTheRule
{
    public class Utilities
    {
        ...
        public static void CallPrivateVoidMethod(object instance, string methodName, object[] parameters)
        {
        ...
        public static object CallPrivateReturnMethod(object instance, string methodName, object[] parameters)
        {
            static object CallPrivateMethodInternal(object instance, string methodName, object[] parameters, Type type)
            {
                MethodInfo method = type.GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Instance);
                ...
                {
                    return CallPrivateMethodInternal(instance, methodName, parameters, type.BaseType);
                }
                else
                {
                    return null;
            ...
            return CallPrivateMethodInternal(instance, methodName, parameters, instance.GetType());
        }
